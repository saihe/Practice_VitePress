    ...
    <table>
      ...
      <tbody>
        <tr v-for="attendance in attendances" :key="attendance.attendanceDate">
          ...
          <td><input type="time" step="1" name="workStartedAt" :value="attendance.workStartedAt" /></td>
          <td><input type="time" step="1" name="workFinishedAt" :value="attendance.workFinishedAt" /></td>
          <td><input type="time" step="1" name="restTime" :value="calcRestTime(attendance.restFinishedAt, attendance.restStartedAt)" /></td>
          <td><input type="time" step="1" name="workTime" :value="calcWorkTime(attendance.workFinishedAt, attendance.workStartedAt, attendance.restFinishedAt, attendance.restStartedAt)" /></td>
          <td><input type="text" name="workDetail" :value="attendance.workDetail" /></td>
        </tr>
      </tbody>
    </table>
  </form>
